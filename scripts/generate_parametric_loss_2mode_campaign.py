"""Generate complete pair-control campaigns for the parametric-loss dimer."""
...
DIMENSIONS = {
    ...
    "epsilon": Dimension("epsilon", 1.0e-3, 5.0),
    "g": Dimension("g", 1.0e-3, 5.0),
    "kappa_a": Dimension("kappa_a", 0.2, 5.0),
    "kappa_2": Dimension("kappa_2", 1.0e-5, 0.1),
}
...
SCHEME_NAMES = {
    frozenset(("omega_a", "epsilon")): "detuning_drive",
    frozenset(("omega_a", "g")): "detuning_coupling",
    frozenset(("omega_a", "kappa_a")): "detuning_linear_loss",
    frozenset(("omega_a", "kappa_2")): "detuning_two_photon_loss",
    frozenset(("epsilon", "g")): "drive_coupling",
    frozenset(("epsilon", "kappa_a")): "drive_linear_loss",
    frozenset(("epsilon", "kappa_2")): "drive_two_photon_loss",
    frozenset(("g", "kappa_a")): "coupling_linear_loss",
    frozenset(("g", "kappa_2")): "coupling_two_photon_loss",
    frozenset(("kappa_a", "kappa_2")): "loss_pair",
}
SCHEMES = tuple(
