...
class BackendBase(PluginBase, Protocol):
    ...
    solve(a, b) -> Any
        Solve batched or unbatched linear systems.
    real(x)/imag(x) -> Any
    ...
    # Additional math / stats helpers (optional expansion for backend-native
    # performance). Callers should fall back to convert_to_numpy + numpy when
    # a backend does not implement these.
