...
class Kerr3ModeModel:
    ...
    Hamiltonian:
    H = ω_a a†a + ω_b b†b + ω_c c†c + g_ab(a†b + b†a)
        + g_ac(a†c + c†a) + χ a†²a²
    ...
    def diffusion(self, y: Any, t: float, p: dict[str, Any]) -> Any:
        ...
        # --- Block A (alpha) ---
        # D_aa = -2i * chi * alpha^2
        # D_aa* = kappa_a/2 ? Text says D = diag(kappa_a, kappa_b, kappa_c)
        # implies E[|dW|^2] ~ kappa dt.
        # Standard P-rep diffusion for loss is zero unless text implies
        # thermal or additive noise.
